...
此分支库为X组件截止2018-05-06最后一个支持.Net 4.0版本，仅为了方便仍然奋斗在FX4上的兄弟们！  
该版本经过测试，能很好的支持Mvc魔方后台。  
在2018年，主线源码库仍然周期性保障.Net4.0版 `NewLife.Core` 和 `XCode` 的维护更新，在nuget上可获取发布版，但不保证.Net4.0版Mvc魔方后台的维护。  
